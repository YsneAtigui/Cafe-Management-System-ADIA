...
public class BillDao {
    ...
    public static void save(Bill bill){
        String query ="insert into bill values('"+bill.getId()+"','"+bill.getName()+"','"+bill.getMoblieNumber()+"','"+bill.getEmail()+"','"+bill.getDate()+"','"+bill.getTotal()+"','"+bill.getCreateBy()+"')";
    ...
    public static ArrayList<Bill> getAllRecordsByInc(String date){
        ...
        try{
            ...
            while(rs.next()){
                ...
                bill.setMoblieNumber(rs.getString("mobileNumber"));
